            ...
            <div class="card-body" style="padding: 0.5rem;">
              ...
              <div class="row">
                <div class="col-sm-12 form-group" style="margin-bottom: 0.4rem;">
                    ...
                    <textarea  maxlength="490" id="instructions" name="instructions" class="form-control" rows="4" placeholder="Instructions">{{$tsiReport['instructions']}}</textarea>
                </div>
              </div><br><br><br><br>
              ...
              <div class="row">
                <div class="col-sm-6 form-group">
                    ...
                    <textarea required maxlength="30000" id="notes" name="notes" class="form-control" rows="4" placeholder="Notes">{{$tsiReport['Notes']}}</textarea>
                </div>
