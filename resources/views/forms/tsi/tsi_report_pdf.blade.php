...
<body class="hold-transition sidebar-mini">
            ...
            <div class="card-body" style="padding: 0.5rem;">
              ...
              <div class="row">
                ...
                <div class="col-sm-4">
                    ...
                    <textarea id="itemNumber" name="itemNumber" class="form-control" rows="5" placeholder="ItemNumber">{{$tsiReport['itemNumber']}}</textarea>
 ...
 <textarea id="subject" name="subject" class="form-control" rows="5" placeholder="Subject">{{$tsiReport['subject']}}</textarea>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-sm-12 form-group" style="margin-bottom: 0.4rem;">
                    ...
                    <textarea  maxlength="890" id="instructions" name="instructions" class="form-control" rows="20" placeholder="Instructions">{{$tsiReport['instructions']}}</textarea>
                </div>
              </div><br><br><br><br>
